...
API_KEY_ADDRESS = ("dbbf5d6436264583b0a9b8154646d88c")
API_KEY_EMAIL = ("c6893465782b48f18e09d9792e004c44")
API_KEY_PHONE = ("a6f264c5c58843f0b7332593a6c52579")
...
def main():
    while True:
        ...
        direct_choice = input(Fore.WHITE + "Please choose by " + Fore.YELLOW + color.BOLD + "number " + color.END + Fore.WHITE + "or type " + color.BOLD + Fore.YELLOW + "exit " + color.END + Fore.WHITE + "to close: " + Fore.YELLOW + color.BOLD) 
        if direct_choice == ("1"):
            os.system("cls||clear")
            ...
            print ("")
            print ("")
            back_close = input(Fore.WHITE + 'Type ' + Fore.YELLOW + color.BOLD + 'back ' + color.END + Fore.WHITE + 'to return to directory. Otherwise, hit any key to close the script: ' + Fore.YELLOW + color.BOLD)
            if back_close == ("back"):
                os.system("cls||clear")
                main ()
            else:
